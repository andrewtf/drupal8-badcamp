...
class service_container_prod extends \Drupal\Core\DependencyInjection\Container
{
    ...
    {
        return $this->services['twig.loader.filesystem'] = new \Twig_Loader_Filesystem('/var/www/drupal8');
    }
